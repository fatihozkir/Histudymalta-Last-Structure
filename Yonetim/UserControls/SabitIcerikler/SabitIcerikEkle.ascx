<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SabitIcerikEkle.ascx.cs" Inherits="SiteProje.Yonetim.UserControls.SabitIcerikler.SabitIcerikEkle" %>
<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>

		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-file-text-o"></i> Sabit Icerik Ekle</h3>
				</div>
			</div>
              <div class="row">
                  <div class="col-lg-12">
