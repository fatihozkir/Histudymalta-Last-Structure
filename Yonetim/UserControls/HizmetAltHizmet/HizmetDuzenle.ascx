<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HizmetDuzenle.ascx.cs" Inherits="SiteProje.Yonetim.UserControls.HizmetAltHizmet.HizmetDuzenle" %>
<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>

		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-file-text-o"></i>
                        <asp:Label ID="LabelBilgi" runat="server" > Düzenle</asp:Label></h3>
				</div>
			</div>
              <div class="row">
                  <div class="col-lg-12">
                              ...
                              <br /><br />
                                ...
                                <div class="form-group">
                                     <label class="col-sm-2 control-label">&nbsp;</label>
                                      <div class="col-sm-10">
                                          <br />
                                          <asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" Text="Düzenle" OnClick="Button1_Click" />
                                                     </div>
                                  </div>
                              <div class="form-group">
                                    <label class="col-sm-2 control-label">&nbsp;</label>
